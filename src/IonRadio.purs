...
foreign import _ionRadio :: ReactComponent IonRadioProps

ionRadio :: forall r. Coercible r IonRadioProps => r -> JSX
ionRadio = ionElement _ionRadio

ionRadio_ :: Array JSX -> JSX
ionRadio_ children = ionRadio {children}
