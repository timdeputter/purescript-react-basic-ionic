...
foreign import _ionFabList :: ReactComponent IonFabListProps

ionFabList :: forall r. Coercible r IonFabListProps => r -> JSX
ionFabList = ionElement _ionFabList

ionFabList_ :: Array JSX -> JSX
ionFabList_ children = ionFabList {children}
