...
foreign import _ionCard :: ReactComponent IonCardProps

ionCard :: forall r. Coercible r IonCardProps => r -> JSX
ionCard = ionElement _ionCard

ionCard_ :: Array JSX -> JSX
ionCard_ children = ionCard {children}
