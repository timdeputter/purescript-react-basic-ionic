...
foreign import _ionContent :: ReactComponent IonContentProps

ionContent :: forall r. Coercible r IonContentProps => r -> JSX
ionContent = ionElement _ionContent

ionContent_ :: Array JSX -> JSX
ionContent_ children = ionContent {children}
