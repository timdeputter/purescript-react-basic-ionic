...
foreign import _ionSpinner :: ReactComponent IonSpinnerProps

ionSpinner :: forall r. Coercible r IonSpinnerProps => r -> JSX
ionSpinner = ionElement _ionSpinner

ionSpinner_ :: Array JSX -> JSX
ionSpinner_ children = ionSpinner {children}
