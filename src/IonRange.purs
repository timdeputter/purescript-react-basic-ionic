...
foreign import _ionRange :: ReactComponent IonRangeProps

ionRange :: forall r. Coercible r IonRangeProps => r -> JSX
ionRange = ionElement _ionRange

ionRange_ :: Array JSX -> JSX
ionRange_ children = ionRange {children}
