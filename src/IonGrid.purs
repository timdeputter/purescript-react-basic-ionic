...
foreign import _ionGrid :: ReactComponent IonGridProps

ionGrid :: forall r. Coercible r IonGridProps => r -> JSX
ionGrid = ionElement _ionGrid

ionGrid_ :: Array JSX -> JSX
ionGrid_ children = ionGrid {children}
