...
foreign import _ionChip :: ReactComponent IonChipProps

ionChip :: forall r. Coercible r IonChipProps => r -> JSX
ionChip = ionElement _ionChip

ionChip_ :: Array JSX -> JSX
ionChip_ children = ionChip {children}
