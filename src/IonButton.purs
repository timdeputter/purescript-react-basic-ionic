...
foreign import _ionButton :: ReactComponent IonButtonProps

ionButton :: forall r. Coercible r IonButtonProps => r -> JSX
ionButton = ionElement _ionButton

ionButton_ :: Array JSX -> JSX
ionButton_ children = ionButton {children}
