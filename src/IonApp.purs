...
foreign import _ionApp :: ReactComponent IonAppProps

ionApp :: forall r. Coercible r IonAppProps => r -> JSX
ionApp = ionElement _ionApp

ionApp_ :: Array JSX -> JSX
ionApp_ children = ionApp {children}
