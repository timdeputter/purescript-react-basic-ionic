...
module Ionic.IonProgressBar where
...
foreign import _ionProgressBar :: ReactComponent IonProgressBarProps

ionProgressBar :: forall r. Coercible r IonProgressBarProps => r -> JSX
ionProgressBar = ionElement _ionProgressBar

ionProgressBar_ :: Array JSX -> JSX
ionProgressBar_ children = ionProgressBar {children}
