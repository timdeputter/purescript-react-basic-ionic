...
foreign import _ionMenu :: ReactComponent IonMenuProps

ionMenu :: forall r. Coercible r IonMenuProps => r -> JSX
ionMenu = ionElement _ionMenu

ionMenu_ :: Array JSX -> JSX
ionMenu_ children = ionMenu {children}
