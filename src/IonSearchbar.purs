...
module Ionic.IonSearchbar where
...
foreign import _ionSearchbar :: ReactComponent IonSearchbarProps

ionSearchbar :: forall r. Coercible r IonSearchbarProps => r -> JSX
ionSearchbar = ionElement _ionSearchbar

ionSearchbar_ :: Array JSX -> JSX
ionSearchbar_ children = ionSearchbar {children}
