...
foreign import _ionBadge :: ReactComponent IonBadgeProps

ionBadge :: forall r. Coercible r IonBadgeProps => r -> JSX
ionBadge = ionElement _ionBadge

ionBadge_ :: Array JSX -> JSX
ionBadge_ children = ionBadge {children}
