...
module Ionic.IonThumbnail where
...
foreign import _ionThumbnail :: ReactComponent IonThumbnailProps

ionThumbnail :: forall r. Coercible r IonThumbnailProps => r -> JSX
ionThumbnail = ionElement _ionThumbnail

ionThumbnail_ :: Array JSX -> JSX
ionThumbnail_ children = ionThumbnail {children}
