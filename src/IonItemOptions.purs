...
module Ionic.IonItemOptions where
...
foreign import _ionItemOptions :: ReactComponent IonItemOptionsProps

ionItemOptions :: forall r. Coercible r IonItemOptionsProps => r -> JSX
ionItemOptions = ionElement _ionItemOptions

ionItemOptions_ :: Array JSX -> JSX
ionItemOptions_ children = ionItemOptions {children}
