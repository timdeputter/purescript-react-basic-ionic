...
foreign import _ionCol :: ReactComponent IonColProps

ionCol :: forall r. Coercible r IonColProps => r -> JSX
ionCol = ionElement _ionCol

ionCol_ :: Array JSX -> JSX
ionCol_ children = ionCol {children}
