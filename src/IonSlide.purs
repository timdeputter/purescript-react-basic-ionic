...
foreign import _ionSlide :: ReactComponent IonSlideProps

ionSlide :: forall r. Coercible r IonSlideProps => r -> JSX
ionSlide = ionElement _ionSlide

ionSlide_ :: Array JSX -> JSX
ionSlide_ children = ionSlide {children}
