...
foreign import _ionList :: ReactComponent IonListProps

ionList :: forall r. Coercible r IonListProps => r -> JSX
ionList = ionElement _ionList

ionList_ :: Array JSX -> JSX
ionList_ children = ionList {children}
