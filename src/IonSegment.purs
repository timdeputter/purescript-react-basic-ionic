...
foreign import _ionSegment :: ReactComponent IonSegmentProps

ionSegment :: forall r. Coercible r IonSegmentProps => r -> JSX
ionSegment = ionElement _ionSegment

ionSegment_ :: Array JSX -> JSX
ionSegment_ children = ionSegment {children}
