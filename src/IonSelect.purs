...
foreign import _ionSelect :: ReactComponent IonSelectProps

ionSelect :: forall r. Coercible r IonSelectProps => r -> JSX
ionSelect = ionElement _ionSelect

ionSelect_ :: Array JSX -> JSX
ionSelect_ children = ionSelect {children}
