...
module Ionic.IonRefresherContent where
...
foreign import _ionRefresherContent :: ReactComponent IonRefresherContentProps

ionRefresherContent :: forall r. Coercible r IonRefresherContentProps => r -> JSX
ionRefresherContent = ionElement _ionRefresherContent

ionRefresherContent_ :: Array JSX -> JSX
ionRefresherContent_ children = ionRefresherContent {children}
