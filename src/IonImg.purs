...
foreign import _ionImg :: ReactComponent IonImgProps

ionImg :: forall r. Coercible r IonImgProps => r -> JSX
ionImg = ionElement _ionImg

ionImg_ :: Array JSX -> JSX
ionImg_ children = ionImg {children}
