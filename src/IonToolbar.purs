...
foreign import _ionToolbar :: ReactComponent IonToolbarProps

ionToolbar :: forall r. Coercible r IonToolbarProps => r -> JSX
ionToolbar = ionElement _ionToolbar

ionToolbar_ :: Array JSX -> JSX
ionToolbar_ children = ionToolbar {children}
