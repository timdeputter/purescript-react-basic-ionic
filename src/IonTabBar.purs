...
foreign import _ionTabBar :: ReactComponent IonTabBarProps

ionTabBar :: forall r. Coercible r IonTabBarProps => r -> JSX
ionTabBar = ionElement _ionTabBar

ionTabBar_ :: Array JSX -> JSX
ionTabBar_ children = ionTabBar {children}
