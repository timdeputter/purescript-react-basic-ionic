...
foreign import _ionReorder :: ReactComponent IonReorderProps

ionReorder :: forall r. Coercible r IonReorderProps => r -> JSX
ionReorder = ionElement _ionReorder

ionReorder_ :: Array JSX -> JSX
ionReorder_ children = ionReorder {children}
