...
foreign import _ionButtons :: ReactComponent IonButtonsProps

ionButtons :: forall r. Coercible r IonButtonsProps => r -> JSX
ionButtons = ionElement _ionButtons

ionButtons_ :: Array JSX -> JSX
ionButtons_ children = ionButtons {children}
