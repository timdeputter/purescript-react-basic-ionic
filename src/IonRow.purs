...
foreign import _ionRow :: ReactComponent IonRowProps

ionRow :: forall r. Coercible r IonRowProps => r -> JSX
ionRow = ionElement _ionRow

ionRow_ :: Array JSX -> JSX
ionRow_ children = ionRow {children}
