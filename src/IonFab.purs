...
foreign import _ionFab :: ReactComponent IonFabProps

ionFab :: forall r. Coercible r IonFabProps => r -> JSX
ionFab = ionElement _ionFab

ionFab_ :: Array JSX -> JSX
ionFab_ children = ionFab {children}
