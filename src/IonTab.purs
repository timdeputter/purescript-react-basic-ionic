...
foreign import _ionTab :: ReactComponent IonTabProps

ionTab :: forall r. Coercible r IonTabProps => r -> JSX
ionTab = ionElement _ionTab

ionTab_ :: Array JSX -> JSX
ionTab_ children = ionTab {children}
