...
foreign import _ionHeader :: ReactComponent IonHeaderProps

ionHeader :: forall r. Coercible r IonHeaderProps => r -> JSX
ionHeader = ionElement _ionHeader

ionHeader_ :: Array JSX -> JSX
ionHeader_ children = ionHeader {children}
