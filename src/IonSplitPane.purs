...
module Ionic.IonSplitPane where
...
foreign import _ionSplitPane :: ReactComponent IonSplitPaneProps

ionSplitPane :: forall r. Coercible r IonSplitPaneProps => r -> JSX
ionSplitPane = ionElement _ionSplitPane

ionSplitPane_ :: Array JSX -> JSX
ionSplitPane_ children = ionSplitPane {children}
