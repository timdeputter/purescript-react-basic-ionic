...
module Ionic.IonCardHeader where
...
foreign import _ionCardHeader :: ReactComponent IonCardHeaderProps

ionCardHeader :: forall r. Coercible r IonCardHeaderProps => r -> JSX
ionCardHeader = ionElement _ionCardHeader

ionCardHeader_ :: Array JSX -> JSX
ionCardHeader_ children = ionCardHeader {children}
