...
foreign import _ionFooter :: ReactComponent IonFooterProps

ionFooter :: forall r. Coercible r IonFooterProps => r -> JSX
ionFooter = ionElement _ionFooter

ionFooter_ :: Array JSX -> JSX
ionFooter_ children = ionFooter {children}
