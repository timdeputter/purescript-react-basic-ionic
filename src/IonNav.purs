...
foreign import _ionNav :: ReactComponent IonNavProps

ionNav :: forall r. Coercible r IonNavProps => r -> JSX
ionNav = ionElement _ionNav

ionNav_ :: Array JSX -> JSX
ionNav_ children = ionNav {children}
