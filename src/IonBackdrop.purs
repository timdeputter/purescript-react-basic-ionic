...
module Ionic.IonBackdrop where
...
foreign import _ionBackdrop :: ReactComponent IonBackdropProps

ionBackdrop :: forall r. Coercible r IonBackdropProps => r -> JSX
ionBackdrop = ionElement _ionBackdrop

ionBackdrop_ :: Array JSX -> JSX
ionBackdrop_ children = ionBackdrop {children}
