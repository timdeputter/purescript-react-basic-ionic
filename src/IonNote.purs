...
foreign import _ionNote :: ReactComponent IonNoteProps

ionNote :: forall r. Coercible r IonNoteProps => r -> JSX
ionNote = ionElement _ionNote

ionNote_ :: Array JSX -> JSX
ionNote_ children = ionNote {children}
