...
module Ionic.IonCheckbox where
...
foreign import _ionCheckbox :: ReactComponent IonCheckboxProps

ionCheckbox :: forall r. Coercible r IonCheckboxProps => r -> JSX
ionCheckbox = ionElement _ionCheckbox

ionCheckbox_ :: Array JSX -> JSX
ionCheckbox_ children = ionCheckbox {children}
