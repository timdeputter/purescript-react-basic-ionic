...
module Ionic.IonMenuButton where
...
foreign import _ionMenuButton :: ReactComponent IonMenuButtonProps

ionMenuButton :: forall r. Coercible r IonMenuButtonProps => r -> JSX
ionMenuButton = ionElement _ionMenuButton

ionMenuButton_ :: Array JSX -> JSX
ionMenuButton_ children = ionMenuButton {children}
