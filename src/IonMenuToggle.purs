...
module Ionic.IonMenuToggle where
...
foreign import _ionMenuToggle :: ReactComponent IonMenuToggleProps

ionMenuToggle :: forall r. Coercible r IonMenuToggleProps => r -> JSX
ionMenuToggle = ionElement _ionMenuToggle

ionMenuToggle_ :: Array JSX -> JSX
ionMenuToggle_ children = ionMenuToggle {children}
