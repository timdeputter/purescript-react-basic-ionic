...
module Ionic.IonRadioGroup where
...
foreign import _ionRadioGroup :: ReactComponent IonRadioGroupProps

ionRadioGroup :: forall r. Coercible r IonRadioGroupProps => r -> JSX
ionRadioGroup = ionElement _ionRadioGroup

ionRadioGroup_ :: Array JSX -> JSX
ionRadioGroup_ children = ionRadioGroup {children}
