...
type IonPageProps = {
    ...
    translate :: String |+| String |+| Undefined,
    ...
    unselectable :: String |+| String |+| Undefined,
    inputMode :: String |+| String |+| String |+| String |+| String |+| String |+| String |+| String |+| Undefined,
    is :: String |+| Undefined,
    ...
    ariaatomic :: Boolean |+| String |+| String |+| Undefined,
    ariaautocomplete :: String |+| String |+| String |+| String |+| Undefined,
    ariabusy :: Boolean |+| String |+| String |+| Undefined,
    ariachecked :: Boolean |+| String |+| String |+| String |+| Undefined,
    ariacolcount :: Number |+| Undefined,
    ariacolindex :: Number |+| Undefined,
    ariacolspan :: Number |+| Undefined,
    ariacontrols :: String |+| Undefined,
    ariacurrent :: Boolean |+| String |+| String |+| String |+| String |+| String |+| String |+| String |+| Undefined,
    ariadescribedby :: String |+| Undefined,
    ariadetails :: String |+| Undefined,
    ariadisabled :: Boolean |+| String |+| String |+| Undefined,
    ariadropeffect :: String |+| String |+| String |+| String |+| String |+| String |+| Undefined,
    ariaerrormessage :: String |+| Undefined,
    ariaexpanded :: Boolean |+| String |+| String |+| Undefined,
    ariaflowto :: String |+| Undefined,
    ariagrabbed :: Boolean |+| String |+| String |+| Undefined,
    ariahaspopup :: Boolean |+| String |+| String |+| String |+| String |+| String |+| String |+| String |+| Undefined,
    ariahidden :: Boolean |+| String |+| String |+| Undefined,
    ariainvalid :: Boolean |+| String |+| String |+| String |+| String |+| Undefined,
    ariakeyshortcuts :: String |+| Undefined,
    arialabel :: String |+| Undefined,
    arialabelledby :: String |+| Undefined,
    arialevel :: Number |+| Undefined,
    arialive :: String |+| String |+| String |+| Undefined,
    ariamodal :: Boolean |+| String |+| String |+| Undefined,
    ariamultiline :: Boolean |+| String |+| String |+| Undefined,
    ariamultiselectable :: Boolean |+| String |+| String |+| Undefined,
    ariaorientation :: String |+| String |+| Undefined,
    ariaowns :: String |+| Undefined,
    ariaplaceholder :: String |+| Undefined,
    ariaposinset :: Number |+| Undefined,
    ariapressed :: Boolean |+| String |+| String |+| String |+| Undefined,
    ariareadonly :: Boolean |+| String |+| String |+| Undefined,
    ariarelevant :: String |+| String |+| String |+| String |+| String |+| Undefined,
    ariarequired :: Boolean |+| String |+| String |+| Undefined,
    ...
    ariaselected :: Boolean |+| String |+| String |+| Undefined,
    ariasetsize :: Number |+| Undefined,
    ariasort :: String |+| String |+| String |+| String |+| Undefined,
...
foreign import _ionPage :: ReactComponent IonPageProps

ionPage :: forall r. Coercible r IonPageProps => r -> JSX
ionPage = element _ionPage <<< coerce
