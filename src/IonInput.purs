...
foreign import _ionInput :: ReactComponent IonInputProps

ionInput :: forall r. Coercible r IonInputProps => r -> JSX
ionInput = ionElement _ionInput

ionInput_ :: Array JSX -> JSX
ionInput_ children = ionInput {children}
