...
foreign import _ionSlides :: ReactComponent IonSlidesProps

ionSlides :: forall r. Coercible r IonSlidesProps => r -> JSX
ionSlides = ionElement _ionSlides

ionSlides_ :: Array JSX -> JSX
ionSlides_ children = ionSlides {children}
