...
foreign import _ionText :: ReactComponent IonTextProps

ionText :: forall r. Coercible r IonTextProps => r -> JSX
ionText = ionElement _ionText

ionText_ :: Array JSX -> JSX
ionText_ children = ionText {children}
