...
foreign import _ionTitle :: ReactComponent IonTitleProps

ionTitle :: forall r. Coercible r IonTitleProps => r -> JSX
ionTitle = ionElement _ionTitle

ionTitle_ :: Array JSX -> JSX
ionTitle_ children = ionTitle {children}
