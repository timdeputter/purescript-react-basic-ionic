...
foreign import _ionLabel :: ReactComponent IonLabelProps

ionLabel :: forall r. Coercible r IonLabelProps => r -> JSX
ionLabel = ionElement _ionLabel

ionLabel_ :: Array JSX -> JSX
ionLabel_ children = ionLabel {children}
