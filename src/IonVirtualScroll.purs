...
module Ionic.IonVirtualScroll where
...
foreign import _ionVirtualScroll :: ReactComponent IonVirtualScrollProps

ionVirtualScroll :: forall r. Coercible r IonVirtualScrollProps => r -> JSX
ionVirtualScroll = ionElement _ionVirtualScroll

ionVirtualScroll_ :: Array JSX -> JSX
ionVirtualScroll_ children = ionVirtualScroll {children}
