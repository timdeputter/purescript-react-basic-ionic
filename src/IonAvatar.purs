...
foreign import _ionAvatar :: ReactComponent IonAvatarProps

ionAvatar :: forall r. Coercible r IonAvatarProps => r -> JSX
ionAvatar = ionElement _ionAvatar

ionAvatar_ :: Array JSX -> JSX
ionAvatar_ children = ionAvatar {children}
