...
foreign import _ionToggle :: ReactComponent IonToggleProps

ionToggle :: forall r. Coercible r IonToggleProps => r -> JSX
ionToggle = ionElement _ionToggle

ionToggle_ :: Array JSX -> JSX
ionToggle_ children = ionToggle {children}
